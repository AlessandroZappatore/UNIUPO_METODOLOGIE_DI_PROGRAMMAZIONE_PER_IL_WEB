...
function showModal(modalId, bodyText, confirmCallback = null) {
    ...
    if (confirmButton) {
        confirmButton.onclick = confirmCallback ? confirmCallback : null;
        confirmButton.style.display = confirmCallback ? 'block' : 'none';
    }
...
//Per far cambiare da ricerca testuale e tendina per la ricerca per genere
...
//Per disabilitare i campi numero stagioni e numero episodi quando è selezionato film
document.addEventListener("DOMContentLoaded", function () {
